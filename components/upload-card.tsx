...
import { DEFAULT_TAX_ENGINE } from "@/lib/types";
...
export function UploadCard() {
  ...
  // Engine is no longer analyst-selectable — Skyvern access was
  // removed from the upload UI; every new run uses Playwright.
  const engine = DEFAULT_TAX_ENGINE;
